window.HUA_PAGES = {
  executiveofficers: {
    title: 'Executive Officers', kicker: 'Leadership', image: '/assets/executive.webp',
  ...
  'executive-team': {
    title: 'Executive Team', kicker: 'How HUA works', image: '/assets/structure.webp',
  ...
  join: {
    title: 'Join the HUA', kicker: 'Take a seat at the table', image: '/assets/widener.webp',
  ...
  'hua-semesterly-grant-opening': {
    title: 'Semesterly Grants', kicker: 'Club funding', image: '/assets/meeting.webp',
  ...
  'election-guidelines': {
    title: 'Election Guidelines', kicker: '2025–2026 academic year', image: '/assets/widener.webp',
  ...
  'teams-and-contacts': {
    title: 'Teams & Contacts', kicker: 'Find the right people', image: '/assets/executive.webp',
  ...
  'crimson-career-closet': {
    title: 'Crimson Career Closet', kicker: 'Dress with confidence', image: '/assets/improve.webp',
  ...
  funding: {
    title: 'Funding Sources', kicker: 'For organizations & projects', image: '/assets/meeting.webp',
  ...
  'club-funding/pubbing': {
    title: 'Club Pubbing', kicker: 'Share your event', image: '/assets/instagram-bg.webp',
  ...
  'club-funding/grant-information': {
    title: 'Grant Information', kicker: 'Plan before you apply', image: '/assets/structure.webp',
  ...
  'club-funding/grant-application': {
    title: 'Grant Application', kicker: 'Prepare your request', image: '/assets/meeting.webp',
  ...
  'club-funding/receipts': {
    title: 'Receipt Collection', kicker: 'Stay compliant', image: '/assets/improve.webp',
  ...
  donations: {
    title: 'Alumni Donations', kicker: 'Invest in student ideas', image: '/assets/widener.webp',

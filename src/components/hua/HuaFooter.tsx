  ...
  return (
    <footer className="bg-[#2a0d13] text-white">
      <div className="mx-auto grid max-w-6xl gap-8 px-6 py-12 sm:grid-cols-[1fr_2fr_1fr] sm:items-start">
        ...
        <div><strong>Follow</strong><p className="mt-2 text-sm leading-7"><a href="https://www.instagram.com/theharvardua/" target="_blank" rel="noopener noreferrer">Instagram</a><br /><a href="https://www.linkedin.com/company/thehua/" target="_blank" rel="noopener noreferrer">LinkedIn</a><br /><Link href="/finance">Finance Team</Link></p></div>
      </div>
    </footer>
  );
}

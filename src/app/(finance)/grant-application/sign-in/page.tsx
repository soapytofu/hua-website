  ...
  return (
    <div className="bg-white rounded-2xl border border-[#E8ECE7] shadow-sm p-10 flex flex-col items-center text-center gap-6">
      <div className="w-16 h-16 rounded-2xl bg-[#F5F8F2] border border-[#E8ECE7] flex items-center justify-center">
        <ShieldCheck className="w-8 h-8 text-[#1F5F0A]" />
      </div>
      ...
      <div>
        ...
        <h1 className="text-2xl font-bold text-[#222222]">Sign in to Apply for Funding</h1>
        <p className="mt-2 text-[#6b7280] text-sm leading-relaxed">
          This page is restricted to Harvard undergraduate students. Please sign in with your{" "}
          <strong className="text-[#222222]">@college.harvard.edu</strong> Google account to
          continue.
        </p>
      </div>
        ...
        <div className="w-full flex items-start gap-3 p-4 rounded-xl bg-red-50 border border-red-200 text-left">
          ...
          <div>
            ...
            <p className="text-xs text-red-700 mt-0.5">
              Only <strong>@college.harvard.edu</strong> accounts and authorized HUA addresses
              can access this page. If you believe this is an error, contact the Finance Team.
            </p>
          </div>
        </div>
      )}
      ...
      <button
        onClick={() => signIn("google", { callbackUrl: "/grant-application" })}
